...
ls -tr $the_destination/*jpg > dailymovie.txt
/usr/bin/mencoder -nosound -ovc lavc -lavcopts vcodec=mpeg4:aspect=16/9:vbitrate=8000000 -vf scale=1280:720 -o $moviename -mf type=jpeg:fps=5  mf://@dailymovie.txt
