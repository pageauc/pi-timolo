...
# Updated - 8-May-2017 IMPORTANT - Required for pi-timolo.py ver 6.00 or Greater
# Done by - Claude Pageau

configTitle = "pi-timolo ver 6.30 Default Settings"
configName  = "config.py"

#======================================
#   pi-timolo.py ver 6.30 Settings
#======================================
...
nightBlackThreshold = 4     # default= 3  dayPixAve where almost no light so Max settings used
...
nightDarkAdjust = 1.1       # default= 1.1 Factor to fine tune nightDarkThreshold brightness (greater is brighter)
