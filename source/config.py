...
twilightThreshold = 90     # Adjust for lighting conditions for day/night mode switching normal setting is between 50 and 100
...
timelapseNumMax = 500      # Max number of timelapse images desired. 0=Continuous  default=0
