...
motionSubDir = False       # True=On files will be saved into directory named after the current date 
...
timelapseSubDir = False    # True=On files will be saved into directory named after the current date 
