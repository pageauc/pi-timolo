...
configTitle = "Demo long duration timelapse only with number sequence file naming"
configName = "demo-timelapse-1080-num.py"
...
# Motion Settings
motionOn = False           # True = motion capture is turned on.  False= No motion detection
