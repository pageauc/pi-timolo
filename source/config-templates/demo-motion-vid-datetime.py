...
configTitle = "Demo motion detection with 30 sec video with datetime file naming"
configName = "demo-motion-timelapse-num.py"
...
motionVideoOn = True       # If set to True then video clip is taken rather than image
...
motionNumOn = False         # True=On (filenames Sequenced by Number) otherwise date/time used for filename
...
timelapseTimer = 3 * 60    # Seconds between timelapse images
