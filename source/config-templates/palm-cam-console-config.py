...
# copy this file to config.py where the pitimolo.py python script is located
# These variables are read by pitimolo.py at launch.
# Purpose - Motion Detection Security Cam
# Created - 13-Dec-2014
# Done by - Claude Pageau
 
# Script Description  
configTitle = "pitimolo Console Texas Palm Tree Camera motion and timelapse 1080 images"
configName = "palm-cam-console-config.py"
...
# Image Settings
imageNamePrefix = 'palm-' # Prefix for all image file names. Eg front-
