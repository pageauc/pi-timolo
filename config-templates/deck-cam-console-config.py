...
# Configuration File Details  (Note Flipped camera image set) 
configTitle = "pitimolo default configuration motion and timelapse 1080 images"
configName = "pitimolo-default-config.py"
...
imageVFlip = True          # Flip image Vertically    default=False
imageHFlip = True          # Flip image Horizontally  default=False
...
sunsetThreshold = 60       # If in Day and pixAverage below this then time to ram to switch to low light mode and ramp settings
